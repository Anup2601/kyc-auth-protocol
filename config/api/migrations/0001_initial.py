...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='customer_profile', to='api.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='Organization',
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='organization_profile', to='api.customuser')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shared_data', models.JSONField(default=dict)),
        ...
        migrations.AddField(
            ...
            name='customers',
            field=models.ManyToManyField(related_name='organizations_joined', through='api.OrganizationCustomer', to='api.customer'),
        ),
        migrations.AddField(
            model_name='customer',
            name='associated_organizations',
            field=models.ManyToManyField(related_name='customers_enrolled', through='api.OrganizationCustomer', to='api.organization'),
        ),
    ]
